...
//        WebDriver driver = new ChromeDriver(options);
        ...
        File addonpath = new File("/Users/cathy/Desktop/WebScraper/Selenium/adblock_plus-2.7.1.xpi");
...
//                System.out.println(thread.appLink);
    ...
    public static List<User> scrapeUsers(List<User> userList){
        ...
        // Writing out data to file
        File file = new File("/Users/cathy/Desktop/WebScraper/UsersThreads&Friends" + dateString + ".csv");
    ...
    public static List<User> scrapeNotes(List<User> userList){
        ...
        // Writing out data to file
        File file = new File("/Users/cathy/Desktop/WebScraper/UsersNotes" + dateString + ".csv");
...
//                }while (pageNumber < (Integer.parseInt(paginationNumber.get(paginationIndex).getText()) +1));
    ...
    public static List<User> scrapeFriends(List<User> userList){
        ...
        // Writing out data to file
        File file = new File("/Users/cathy/Desktop/WebScraper/UsersFriends" + dateString + ".csv");
...
//                        }
    ...
    public static List<User> scrapePosts(List<User> userList){
        ...
        File file = new File("/Users/cathy/Desktop/WebScraper/UsersPosts-" + dateString + ".csv");
